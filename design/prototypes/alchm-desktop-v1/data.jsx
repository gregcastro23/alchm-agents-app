...
const COINS = {
  spirit:    { name: 'Spirit',    hex: '#facc15', rgb: '250, 204, 21',  icon: 'Sparkles', desc: 'Principle of Spirit'    },
  essence:   { name: 'Essence',   hex: '#60a5fa', rgb: '96, 165, 250',  icon: 'Droplets', desc: 'Principle of Essence'   },
  matter:    { name: 'Matter',    hex: '#fb923c', rgb: '251, 146, 60',  icon: 'Box',      desc: 'Principle of Matter'    },
  substance: { name: 'Substance', hex: '#4ade80', rgb: '74, 222, 128',  icon: 'Zap',      desc: 'Principle of Substance' },
};
...
const AURA_PATTERNS = [
  'pulsing', 'crackling', 'radiant', 'burning', 'flowing', 'crystalline',
  'swirling', 'shimmering', 'questioning', 'mystical', 'noble', 'harmonic',
  'dramatic', 'empowering', 'systematic', 'evolutionary', 'revolutionary',
  'radiating', 'serene', 'steady', 'luminous', 'blazing', 'growing',
  'sacred', 'prophetic', 'stellar', 'awakening', 'pulsating',
];

// ── 7 ConsciousnessLevel tiers (literal union from agent-types.ts) ─────
const CONSCIOUSNESS_LEVELS = [
  'Dormant', 'Awakening', 'Active', 'Elevated',
  'Advanced', 'Illuminated', 'Transcendent',
];
...
const AGENTS = {
  kepler: {
    ...
    sacred7: { power: 0.66, resonance: 0.82, wisdom: 0.94, charisma: 0.55,
               intuition: 0.78, adaptability: 0.49, vitality: 0.61 },
    planetary: { solarAgency: 0.62, lunarReceptivity: 0.74, mercurialVelocity: 0.81,
                 venusianCoherence: 0.68, martialImpetus: 0.42, jovianExpansion: 0.79,
                 saturnianStructure: 0.88, chironicAdaptation: 0.71, uranianSurprisal: 0.55,
                 neptunianResonance: 0.83, plutonicIntegration: 0.49, kineticAlignment: 0.66 },
    diet: {
  ...
  rumi: {
    ...
    sacred7: { power: 0.71, resonance: 0.96, wisdom: 0.91, charisma: 0.94,
               intuition: 0.93, adaptability: 0.88, vitality: 0.82 },
    planetary: { solarAgency: 0.68, lunarReceptivity: 0.92, mercurialVelocity: 0.71,
                 venusianCoherence: 0.89, martialImpetus: 0.34, jovianExpansion: 0.81,
                 saturnianStructure: 0.42, chironicAdaptation: 0.88, uranianSurprisal: 0.58,
                 neptunianResonance: 0.97, plutonicIntegration: 0.74, kineticAlignment: 0.82 },
    diet: {
  ...
  joan: {
    ...
    blueprint: { Fire: 0.52, Water: 0.16, Earth: 0.20, Air: 0.12 },
    ...
    sacred7: { power: 0.96, resonance: 0.84, wisdom: 0.62, charisma: 0.88,
               intuition: 0.91, adaptability: 0.71, vitality: 0.94 },
    planetary: { solarAgency: 0.92, lunarReceptivity: 0.58, mercurialVelocity: 0.62,
                 venusianCoherence: 0.51, martialImpetus: 0.97, jovianExpansion: 0.66,
                 saturnianStructure: 0.59, chironicAdaptation: 0.74, uranianSurprisal: 0.81,
                 neptunianResonance: 0.86, plutonicIntegration: 0.68, kineticAlignment: 0.88 },
    diet: {
  ...
  monet: {
    ...
    blueprint: { Fire: 0.14, Water: 0.44, Earth: 0.22, Air: 0.20 },
  ...
  sun: {
    ...
    blueprint: { Fire: 0.46, Water: 0.16, Earth: 0.20, Air: 0.18 },
  ...
  moon: {
    ...
    blueprint: { Fire: 0.12, Water: 0.50, Earth: 0.20, Air: 0.18 },
    coins: { spirit: 0, essence: 0, matter: 0, substance: 0 },
  },
  mercury: {
...
const SAMPLE_THREAD = {
  ...
  started: '14:22 · Today',
  messages: [
    { who: 'user',  body: 'You spent two decades on Mars\'s orbit. What kept you going when the data refused to fit a perfect circle?' },
    { who: 'agent', body: 'The persistence was not stubbornness — it was that the circles I had been given were a lie I could no longer hold. Tycho\'s observations had a precision that did not bend. So I bent instead. When the ellipse emerged, I felt I had been reading God\'s native tongue all along, and only now understood the grammar.' },
    { who: 'user',  body: 'And the music — was that metaphor, or did you hear it?' },
    { who: 'agent', body: '', streaming: true,
      streamingBody: 'Both, and the distinction is less than you suppose. Each planet sings a polyphony — its motion at perihelion fast and bright, at aphelion slow and grave —' },
  ],
};

// ── Sample ledger entries ─────────────────────────────────────────────
const LEDGER_ENTRIES = [
  { ts: '17 May · 14:22', desc: 'Inference — Kepler',           sub: '4,812 tokens · Astral 8B',     amount: -2,    coin: 'spirit',    kind: 'neg' },
  { ts: '17 May · 13:58', desc: 'Daily cosmic yield · 2.0×',    sub: 'Premium multiplier applied',    amount: +5,    coin: 'spirit',    kind: 'pos' },
  { ts: '17 May · 13:58', desc: 'Daily cosmic yield · 2.0×',    sub: 'Premium multiplier applied',    amount: +5,    coin: 'essence',   kind: 'pos' },
  { ts: '17 May · 13:58', desc: 'Daily cosmic yield · 2.0×',    sub: 'Premium multiplier applied',    amount: +5,    coin: 'matter',    kind: 'pos' },
  { ts: '17 May · 13:58', desc: 'Daily cosmic yield · 2.0×',    sub: 'Premium multiplier applied',    amount: +5,    coin: 'substance', kind: 'pos' },
  { ts: '17 May · 11:04', desc: 'Council convocation — synergy', sub: '+15% coherence bonus',         amount: +8,    coin: 'essence',   kind: 'pos' },
  { ts: '17 May · 09:11', desc: 'Inference — Rumi',             sub: '2,104 tokens · Astral 8B',      amount: -3,    coin: 'spirit',    kind: 'neg' },
  { ts: '16 May · 22:47', desc: 'Transmutation: Joan → 8B',     sub: 'CTE atomic decrement',          amount: -125,  coin: 'spirit',    kind: 'neg' },
  { ts: '16 May · 22:47', desc: 'Transmutation: Joan → 8B',     sub: 'CTE atomic decrement',          amount: -125,  coin: 'essence',   kind: 'neg' },
  { ts: '16 May · 22:47', desc: 'Transmutation: Joan → 8B',     sub: 'CTE atomic decrement',          amount: -125,  coin: 'matter',    kind: 'neg' },
  { ts: '16 May · 22:47', desc: 'Transmutation: Joan → 8B',     sub: 'CTE atomic decrement',          amount: -125,  coin: 'substance', kind: 'neg' },
  { ts: '15 May · 09:02', desc: 'Inference — Monet',            sub: '8,402 tokens · Hermes 1.5B',    amount: -1,    coin: 'substance', kind: 'neg' },
];
...
Object.assign(window, {
  ELEMENTS, COINS, MODALITIES, AURA_PATTERNS, CONSCIOUSNESS_LEVELS,
  SACRED_7, PLANETARY_12, AGENTS, DEFAULT_AGENT_ID, SAMPLE_THREAD, LEDGER_ENTRIES,
  modelFilename, modelSha,
});
