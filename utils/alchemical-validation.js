...
export class AlchemicalValidator {
     ...
     */
    validateGoldenBalance(tokens, context) {
    ...
    validateComprehensive(tokens, context) {
        ...
        const score = (goldenResult.score * weights.golden +
            dignityResult.score * weights.dignity +
            voidResult.score * weights.void);
        const hermeticAlignment = (goldenResult.hermeticAlignment * weights.golden +
     ...
     */
    getPlanetaryDignity(planet, context) {
