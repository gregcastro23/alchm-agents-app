...
export function combineElementObjects(element_object_1: Record<string, number>, element_object_2: Record<string, number>): Record<string, number> {
...
export function getElementRanking(element_object: Record<string, number>, rank = 1): Record<number, string> {
...
export function getAbsoluteElementValue(element_object: Record<string, number>): number {
  return element_object['Fire'] + element_object['Water'] + element_object['Air'] + element_object['Earth'];
}
    ...
    const horoscope = {
      tropical: {
        ...
        CelestialBodies: {
          ...
          sun: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Sun'].degree}°` } } },
          moon: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Moon'].degree}°` } } },
          mercury: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Mercury'].degree}°` } } },
          venus: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Venus'].degree}°` } } },
          mars: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Mars'].degree}°` } } },
          jupiter: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Jupiter'].degree}°` } } },
          saturn: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Saturn'].degree}°` } } },
          uranus: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Uranus'].degree}°` } } },
          neptune: { ChartPosition: { Ecliptic: { ArcDegreesFormatted30: `${currentPositions['Neptune'].degree}°` } } },
