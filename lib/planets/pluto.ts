...
const plutoData: PlanetData = {
  ...
  'AstrologicalProperties': {
    ...
    'Fall': 'Aquarius',
    'Detriment': ['Taurus'],
    'Keywords': ['transformation', 'death and rebirth', 'power', 'intensity', 'depth', 'shadow', 'regeneration', 'obsession', 'destruction', 'catharsis', 'unconscious'],
    'Colors': ['black', 'deep red', 'dark purple', 'obsidian', 'charcoal'],
    'Day': 'Tuesday',
    'Metal': 'Plutonium',
    'BodyParts': ['reproductive organs', 'excretory system', 'bone marrow', 'DNA', 'cellular regeneration'],
  ...
  'ElementalConnections': {
    ...
    'ElementalBridges': ['Earth-Water transmutation', 'Alchemical transformation'],
    'SharedElements': {
      'Mars': ['Water'],
      'Saturn': ['Earth'],
      'Venus': ['Earth']
  ...
  'FoodAssociations': [
    ...
    'aged and intense foods',
    'offal and organ meats',
    'deeply umami ingredients',
    'foods that undergo transformation',
    'rich fungi',
    'extreme flavors',
  ...
  'CulinaryInfluences': [
    ...
    'Unlocks hidden depths in ingredients',
    'Supports fermentation and controlled decay',
  ...
  'PlanetSpecific': {
    'ZodiacTransit': {
      ...
      'Leo': {
        ...
        'CookingMethods': ['charring', 'flame-grilling', 'dramatic tableside presentation', 'ancient cooking methods', 'primal fire techniques'],
      ...
      'Capricorn': {
        ...
        'CookingMethods': ['slow-cooking', 'underground cooking', 'structural transformation', 'ancestral techniques', 'traditional preservation'],
        'FavoredIngredients': ['root vegetables', 'bones', 'marrow', 'structural elements', 'ancient grains', 'geological references'],
        'FlavorCombinations': 'Gradual depth development, foundations that transform, slow-revealing complexity'
      }
    },
    'Retrograde': {
      'CulinaryEffect': 'Revisiting traditional preservation methods, uncovering ancient cooking techniques',
      'ElementalShift': {
        'Spirit': 0.2,
        'Essence': 0.7,
        'Matter': 0.8,
      ...
      'CookingMethodEffects': {
        'Emphasized': ['traditional preservation', 'archetypal cooking methods', 'ancestral techniques', 'unearthing forgotten approaches'],
        'Diminished': ['excessive intensity', 'overly destructive techniques', 'manipulative presentation']
      },
      'IngredientEffects': {
        'Emphasized': ['heritage ingredients', 'ancestral foods', 'historically significant components', 'foods with lineage'],
        'Diminished': ['unnecessarily shocking elements', 'gratuitously intense flavors', 'superficially dramatic presentations']
      },
      'FlavorModulation': {
        'Sweet': 0.3,
        'Sour': 0.5,
