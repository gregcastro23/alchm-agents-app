...
class PlanetaryHoursService {
     ...
     */
    async getCurrentPlanetaryHour(datetime = new Date(), location) {
        ...
        const modifiers = PLANETARY_MODIFIERS[planet] || {};
        const result = {
            planet,
     ...
     */
    async getForecast(startDate, endDate, location, intervalMinutes = 60) {
     ...
     */
    calculatePlanetaryInfluence(planetaryHour) {
        const baseInfluence = {
            spirit: 1.0,
            essence: 1.0,
            matter: 1.0,
     ...
     */
    async getOptimalTimes(date, location, targetPlanet) {
...
//# sourceMappingURL=planetary-hours.js.map