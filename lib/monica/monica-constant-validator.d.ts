 ...
 */
export declare function calculateMC(spirit: number, essence: number, matter: number, substance: number, fire?: number, water?: number, air?: number, earth?: number): number;
/**
