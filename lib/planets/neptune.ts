...
const neptuneData: PlanetData = {
  ...
  'AstrologicalProperties': {
    ...
    'Fall': 'Capricorn',
    'Detriment': ['Virgo'],
    'Keywords': ['dissolution', 'spirituality', 'illusion', 'dreams', 'transcendence', 'mysticism', 'compassion', 'universality', 'intuition', 'inspiration', 'imagination'],
    'Colors': ['sea blue', 'indigo', 'iridescent hues', 'opalescent', 'misty colors'],
    'Day': 'Thursday',
    'Metal': 'Neptunium',
    'BodyParts': ['pineal gland', 'feet', 'lymphatic system', 'psychic centers', 'tears', 'mucus membranes'],
  ...
  'ElementalConnections': {
    ...
    'ElementalBridges': ['Water-Spirit interaction', 'Dissolution of boundaries'],
    'SharedElements': {
      'Moon': ['Water'],
      'Uranus': ['Water'],
      'Venus': ['Water']
  ...
  'FoodAssociations': [
    'seafood',
    'seaweed',
    'ethereal presentations',
    'alcoholic beverages',
    'infusions',
    'elixirs',
    'clear broths',
    'iridescent foods',
    'misty and foamy textures',
    'subtle flavors',
    'water-based dishes'
  ],
  'FlavorProfiles': {
  ...
  'CulinaryInfluences': [
    ...
    'Enhances subtle and delicate tastes',
    'Dissolves structure in cooking',
  ...
  'PlanetSpecific': {
    'ZodiacTransit': {
      ...
      'Cancer': {
        ...
        'CookingMethods': ['gentle simmering', 'braising', 'slow poaching', 'steam infusions', 'intuitive cooking'],
      ...
      'Virgo': {
        ...
        'CookingMethods': ['precise temperature control', 'delicate herbal infusions', 'medicinal food preparations', 'healing broths', 'purification techniques'],
        'FavoredIngredients': ['healing herbs', 'pure water', 'cleansing ingredients', 'digestively balanced components', 'subtle healing elements'],
        'FlavorCombinations': 'Clarifying contrasts, purifying progressions, subtly medicinal combinations'
      }
    },
    'Retrograde': {
      'CulinaryEffect': 'Clarifying previously confused flavor combinations, bringing definition to ethereal dishes',
      'ElementalShift': {
        'Spirit': 0.2,
        'Essence': 0.8,
        'Matter': 0.1,
      ...
      'CookingMethodEffects': {
        'Emphasized': ['clarifying techniques', 'precision in subtle methods', 'intentional reduction of confusion'],
        'Diminished': ['overly nebulous presentations', 'confusing flavor combinations', 'disorganized aesthetic']
      },
      'IngredientEffects': {
        'Emphasized': ['clarifying agents', 'transparent ingredients', 'soothing components', 'grounding elements in ethereal dishes'],
        'Diminished': ['overly intoxicating ingredients', 'confusing mixtures', 'deceptive presentations']
      },
      'FlavorModulation': {
        'Sweet': 0.4,
        'Sour': 0.3,
