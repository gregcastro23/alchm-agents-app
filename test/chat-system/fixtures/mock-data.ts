...
import type { HistoricalCouncilPreset, PlanetaryCouncilPreset, MixedCouncilPreset } from '@/lib/council-presets'
...
export const mockMessages: Message[] = [
  ...
  },
  {
    ...
    content: 'Consciousness is like an iceberg - what we see on the surface is merely the tip. The unconscious depths contain vast archetypal patterns that shape our experience. To expand consciousness, we must make the unconscious conscious through shadow work and individuation.',
    timestamp: new Date('2025-01-01T10:00:30Z'),
    processingTime: 850,
    metadata: {
      synthesizedInsights: ['Shadow integration is key to consciousness expansion', 'Archetypes influence conscious experience'],
  ...
  },
  {
    ...
    content: 'Ah, mio amico! Consciousness is the divine spark that allows us to perceive, create, and transcend. Like my anatomical studies revealed the body\'s mysteries, we must dissect the mind\'s workings. Observe nature, ask questions, create art - these expand the vessel of awareness!',
    timestamp: new Date('2025-01-01T10:01:00Z'),
    processingTime: 920,
    metadata: {
      synthesizedInsights: ['Observation and creation expand consciousness', 'Nature holds keys to awareness'],
...
export const performanceTestData = {
  ...
  complexMessage: 'This is a complex philosophical question about the nature of consciousness, reality, and the interconnectedness of all beings that requires deep contemplation and multi-layered responses from various perspectives.',
