...
import { defaultAlchemicalMCPConfig, validateTokenEquilibrium } from '@/testing/alchemical-devtools/mcp-config';
/**
...
const EMERGENCY_PROTOCOLS = [
    {
        ...
        triggerCondition: (tokens, event) => event.type === 'eclipse' &&
    ...
    },
    {
        ...
        triggerCondition: (tokens, event) => event.type === 'grand_cross' &&
    ...
    },
    {
        ...
        triggerCondition: (tokens, event) => event.type === 'retrograde_storm' &&
    ...
    },
    {
        ...
        triggerCondition: (tokens, event) => event.type === 'planetary_station' &&
    ...
    },
    {
        ...
        triggerCondition: (tokens, event) => event.type === 'void_moon' &&
            tokens.essence < defaultAlchemicalMCPConfig.tokenStabilization.essence.min,
        stabilizationAction: (tokens, event) => {
