...
const agents = [
  'monica-001', 'carl-jung', 'nikola-tesla', 'cleopatra', 'frida-kahlo',
  'leonardo-da-vinci', 'marie-curie', 'socrates', 'rumi', 'marcus-aurelius',
  'vincent-van-gogh', 'wolfgang-mozart', 'william-shakespeare', 'maya-angelou',
  'isaac-newton', 'charles-darwin', 'galileo-galilei', 'benjamin-franklin',
  'eleanor-roosevelt', 'mahatma-gandhi', 'confucius', 'lao-tzu',
  'siddhartha-gautama-buddha', 'murasaki-shikibu', 'ibn-sina-avicenna',
  'tecumseh', 'wangari-maathai', 'sitting-bull', 'joan-of-arc',
