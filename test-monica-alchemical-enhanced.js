...
async function testAlchemicalTraining() {
  ...
  try {
    ...
    if (data.success) {
      ...
      console.log(
        `    Spirit peaks at ${result.peaks.spirit.hour}:00 (value: ${result.peaks.spirit.value}, ruler: ${result.peaks.spirit.ruler})`
      )
      console.log(
        `    Essence peaks at ${result.peaks.essence.hour}:00 (value: ${result.peaks.essence.value}, ruler: ${result.peaks.essence.ruler})`
      )
      console.log(
        `    Energy peaks at ${result.peaks.energy.hour}:00 (value: ${result.peaks.energy.value}, ruler: ${result.peaks.energy.ruler})`
      )
