...
export const MAJOR_ARCANA_PLANETARY: Record<string, MajorArcanaCard> = {
  ...
  "Saturn": {
    ...
    meaning: "Ultimate completion and mastery. Saturnian achievement through disciplined integration.",
  ...
  "Uranus": {
    ...
    meaning: "New beginnings and unlimited potential. Uranian innovation and spontaneous awakening.",
  ...
  "Neptune": {
    ...
    meaning: "Spiritual surrender and transcendence. Neptunian dissolution of ego for higher wisdom.",
  ...
  "Pluto": {
    ...
    meaning: "Death and rebirth cycles. Plutonian transformation through deep psychological renewal.",
...
export const ZODIAC_MAJOR_ARCANA: Record<string, MajorArcanaCard> = {
  ...
  "Taurus": {
    ...
    meaning: "Spiritual tradition and earthly wisdom. Taurus stability through established knowledge.",
  ...
  "Leo": {
    ...
    meaning: "Inner strength and courage. Leo heart-centered power through compassionate leadership.",
...
export function calculateChakraActivation(
  ...
  const sortedChakras = Object.entries(chakraEnergy)
    .sort(([,a], [,b]) => b - a)
...
export function generateDevelopmentPath(
  ...
  const skillsToFocus = [
    ...currentCard.keywords.slice(0, 2),
    ...planetaryCard.keywords.slice(0, 2)
  ]
...
function getShadowWork(currentCard: TarotCard, planetaryCard: MajorArcanaCard): string[] {
  ...
  if (currentCard.element === 'Water') shadows.push("Address emotional overwhelm and boundary issues")
  ...
  if (planetaryCard.planetaryRuler === 'Venus') shadows.push("Heal self-worth and relationship patterns")
  if (planetaryCard.planetaryRuler === 'Saturn') shadows.push("Transform limiting beliefs and fear")
  if (planetaryCard.planetaryRuler === 'Mercury') shadows.push("Clarify communication and mental patterns")
...
function getIntegrationPractices(currentCard: TarotCard, planetaryCard: MajorArcanaCard): string[] {
  ...
  // Planetary practices
  if (planetaryCard.planetaryRuler === 'Sun') practices.push("Solar meditation and vitality practices")
  if (planetaryCard.planetaryRuler === 'Moon') practices.push("Lunar cycles and intuitive development")
  if (planetaryCard.planetaryRuler === 'Jupiter') practices.push("Expansion practices and wisdom study")
  if (planetaryCard.planetaryRuler === 'Saturn') practices.push("Discipline building and structure creation")
...
export function generateTimeRecommendations(
  ...
  if (planetaryCard.planetaryRuler === 'Moon') moonPhaseAlignment = "Full Moon for intuitive insights"
