  ...
  const processedData = useMemo(() => {
    ...
    return data.map((moment, index) => {
      const processedMoment: any = {
        index,
        timestamp: moment.timestamp.getTime(),
        formattedTime: moment.timestamp.toLocaleTimeString(),
        formattedDate: moment.timestamp.toLocaleDateString(),
        ...
        Fire: moment.elemental.Fire,
        Water: moment.elemental.Water,
        Air: moment.elemental.Air,
        Earth: moment.elemental.Earth,
