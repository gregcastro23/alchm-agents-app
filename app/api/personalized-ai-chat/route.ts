    ...
    try {
      ...
      try {
        ...
        if (archetype.toLowerCase().includes('sage') || archetype.toLowerCase().includes('wise')) {
          ...
          archetype.toLowerCase().includes('creator') ||
          archetype.toLowerCase().includes('artist')
        ) {
          ...
          archetype.toLowerCase().includes('explorer') ||
          archetype.toLowerCase().includes('seeker')
        ) {
          ...
          archetype.toLowerCase().includes('caregiver') ||
          archetype.toLowerCase().includes('nurturer')
        ) {
