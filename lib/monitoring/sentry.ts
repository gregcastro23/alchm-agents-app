...
export function trackConsciousnessError(error: Error, context: {
  agentId?: string
  userId?: string
...
export function trackConsciousnessPerformance(operation: string, duration: number, metadata: any = {}) {
