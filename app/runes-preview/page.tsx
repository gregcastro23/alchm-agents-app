...
export default function RunesPreviewPage() {
  ...
  const currentConditions = conditionsData?.conditions.reduce((acc, condition) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          <CardContent>
            {error ? (
              <Alert>
                ...
                <AlertDescription>
                  {error} - Using fallback conditions for preview
                </AlertDescription>
              </Alert>
            ) : (
                  ...
                  <div className="space-y-3">
                    <div className="flex flex-wrap gap-2 justify-center">
                      {conditionsData.conditions.map((condition, index) => (
                        <Badge 
                          key={index} 
                          variant={condition.multiplier < 1 ? "default" : condition.multiplier > 1 ? "destructive" : "outline"}
                          className="text-xs"
                        >
                          {condition.effect}
                        </Badge>
                    ...
                    <div className="text-sm text-gray-600 grid grid-cols-3 gap-4 max-w-md mx-auto">
                      <div className="text-center">
                        <div className="font-bold text-lg">{conditionsData.summary.activeCount}</div>
                        <div>Active</div>
                      </div>
                      <div className="text-center">
                        <div className="font-bold text-lg text-green-600">{conditionsData.summary.favorableCount}</div>
                        <div>Favorable</div>
                      </div>
                      <div className="text-center">
                        <div className="font-bold text-lg text-red-600">{conditionsData.summary.unfavorableCount}</div>
                        <div>Unfavorable</div>
                      </div>
                    </div>
                  </div>
      ...
      <Alert className="mb-6 max-w-4xl mx-auto">
        <Info className="h-4 w-4" />
        <AlertDescription>
          <strong>Preview Mode:</strong> This is a demonstration of the Runes system. 
          Prices are calculated based on real-time astrological conditions from your Alchm system. 
          In the full implementation, users would spend actual resources and receive functional runes.
        </AlertDescription>
      </Alert>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="text-sm space-y-1 text-gray-600">
                <li><strong>Consciousness:</strong> Enhance awareness and perception</li>
                <li><strong>Protection:</strong> Shield against negative energies</li>
                <li><strong>Enhancement:</strong> Amplify existing abilities</li>
                <li><strong>Manifestation:</strong> Bring intentions into reality</li>
                <li><strong>Divination:</strong> Reveal hidden knowledge</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm space-y-1 text-gray-600">
                <li><strong>Common:</strong> Basic utility runes</li>
                <li><strong>Uncommon:</strong> Enhanced effects</li>
                <li><strong>Rare:</strong> Specialized abilities</li>
                <li><strong>Epic:</strong> Powerful consciousness tools</li>
                <li><strong>Legendary:</strong> Reality-altering capabilities</li>
                <li><strong>Cosmic:</strong> Universe-level influence</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm space-y-1 text-gray-600">
                <li><strong>Spirit:</strong> Consciousness and cosmic energy</li>
                <li><strong>Essence:</strong> Emotional and intuitive power</li>
                <li><strong>Matter:</strong> Physical manifestation force</li>
                <li><strong>Substance:</strong> Structural and binding energy</li>
              </ul>
            </div>
          </div>
        </CardContent>
