    ...
    <Card className={`bg-gradient-to-br from-slate-900/50 to-purple-900/50 border-purple-500/50 ${className}`}>
      <CardHeader>
        <div className="flex items-center gap-4">
          <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${archetype.color} flex items-center justify-center text-white text-2xl`}>
            {archetype.symbol}
          </div>
          <div className="flex-1">
            <CardTitle className="text-purple-300 text-xl">{name || "Unnamed Consciousness"}</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="p-4 bg-purple-900/20 rounded-lg border border-purple-500/30">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            ...
            Primary expression through {getDominantMode.name.toLowerCase()} mode, bringing unique wisdom to every interaction.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="p-3 bg-red-900/30 rounded-lg text-center">
              ...
              <div className="text-xl font-bold text-red-300">{alchemicalValues.spirit.toFixed(1)}</div>
            </div>
            <div className="p-3 bg-blue-900/30 rounded-lg text-center">
              <div className="text-blue-400 text-sm">Essence</div>
              <div className="text-xl font-bold text-blue-300">{alchemicalValues.essence.toFixed(1)}</div>
            </div>
            <div className="p-3 bg-yellow-900/30 rounded-lg text-center">
              <div className="text-yellow-400 text-sm">Matter</div>
              <div className="text-xl font-bold text-yellow-300">{alchemicalValues.matter.toFixed(1)}</div>
            </div>
            <div className="p-3 bg-green-900/30 rounded-lg text-center">
              <div className="text-green-400 text-sm">Substance</div>
              <div className="text-xl font-bold text-green-300">{alchemicalValues.substance.toFixed(1)}</div>
            </div>
          </div>
        </div>
