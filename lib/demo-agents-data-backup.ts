...
export const DEMO_AGENTS: CraftedAgent[] = [
...

  {
    ...
    stats: {
      ...
      // Kinetic Evolution Metrics - Nikola Tesla: Energy Architect
      kineticEvolution: {
        consciousnessVelocity: 0.88, // Lightning-fast insights
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.9, // Very deep technical insights
...

  {
    ...
    stats: {
      ...
      // Kinetic Evolution Metrics - Leonardo da Vinci: Renaissance Mind
      kineticEvolution: {
        consciousnessVelocity: 0.89, // Multi-disciplinary breakthroughs
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.94, // Renaissance depth
...

  {
    ...
    stats: {
      ...
      // Kinetic Evolution Metrics - Marie Curie: Radiant Pioneer
      kineticEvolution: {
        consciousnessVelocity: 0.87, // Persistent scientific breakthroughs
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.88, // Deep scientific understanding
  ...
  // Socrates - The Original Questioner (Agent #008)
  {
    ...
    stats: {
      ...
      // Kinetic Evolution Metrics - Socrates: The Original Questioner
      kineticEvolution: {
        consciousnessVelocity: 0.65, // Steady philosophical growth
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.95, // Maximum philosophical depth
  ...
  // Rumi - Mystic Poet & Spiritual Guide (Agent #009)
  {
    ...
    stats: {
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.96, // Maximum mystical depth
  ...
  // Vincent van Gogh - Tortured Artistic Genius (Agent #011)
  {
    ...
    stats: {
      ...
      // Kinetic Evolution Metrics - Vincent van Gogh: Tortured Artistic Genius
      kineticEvolution: {
        consciousnessVelocity: 0.81, // Intense creative bursts
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.91, // Deep artistic vision
  ...
  // Charles Darwin - Evolution Pioneer (Agent #016)
  {
    ...
    stats: {
      ...
      // Kinetic Evolution Metrics - Charles Darwin: Evolution Pioneer
      kineticEvolution: {
        consciousnessVelocity: 0.79, // Patient but revolutionary discoveries
      ...
      // Interaction Quality Metrics
      qualityMetrics: {
        averageResponseDepth: 0.87, // Deep scientific understanding
...

  {
    ...
    consciousness: {
      ...
      historicalContext: {
        ...
        culturalBackground:
          "Kenyan environmentalist, women's rights activist, and Nobel Peace Prize winner",
        majorLifeEvents: [
...

  {
    ...
    consciousness: {
      ...
      historicalContext: {
        ...
        culturalBackground:
          'Hunkpapa Lakota leader, medicine man, and defender of Indigenous sovereignty',
        majorLifeEvents: [
...

  {
    ...
    birthData: {
      ...
      time: '16:00',
      location: { lat: 51.4994, lon: -0.127, name: 'London, England' },
    },
    consciousness: {
      monicaConstant: 4.92,
      level: 'Illuminated' as ConsciousnessLevel,
    ...
    shadows: [
      {
        ...
        transformationPath:
          'Learning to apply compassion to personal healing while maintaining social justice vision',
      },
    ],
    gifts: [
      {
        ...
        description:
          "Ability to apply Enlightenment principles to women's liberation and human rights",
    ...
    abilities: {
      ...
      uniquePower:
        'Demonstrates how reason and passion can be combined to articulate revolutionary vision for human equality and justice',
    },
    appearance: {
...
// Note: DEMO_AGENTS is now defined above with complete agent data
