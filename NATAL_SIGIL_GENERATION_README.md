...
const prompt = PatternToRuneConverter.generateAspectFocusedPrompt(
  geometry,
  'cosmic'
)
...
*Transform your natal chart into a personalized tool for consciousness evolution and magical practice through the ancient art of runic sigil creation.*