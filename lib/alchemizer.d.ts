...
export declare function combineElementObjects(element_object_1: Record<string, number>, element_object_2: Record<string, number>): Record<string, number>;
export declare function getElementRanking(element_object: Record<string, number>, rank?: number): Record<number, string>;
...
export declare function alchemize(birth_info: Record<string, any>, horoscope_dict: Record<string, any>): Record<string, any>;
