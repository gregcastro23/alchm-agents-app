...
const uranusData: PlanetData = {
  ...
  'AstrologicalProperties': {
    ...
    'Fall': 'Taurus',
    'Detriment': ['Leo'],
    'Keywords': ['revolution', 'disruption', 'enlightenment', 'freedom', 'innovation', 'unexpected change', 'rebellion', 'technology', 'genius', 'lightning', 'electricity'],
    'Colors': ['electric blue', 'metallic silver', 'neon purple', 'ultraviolet'],
    'Day': 'Wednesday',
    'Metal': 'Uranium',
    'BodyParts': ['nervous system', 'electrical impulses', 'ankles', 'circulation', 'aura', 'bioelectric field'],
  ...
  'HerbalAssociations': {
    ...
    'Woods': ['lightning-struck wood', 'tulip poplar', 'ash', 'yew'],
    'Scents': ['ozone', 'petrichor', 'metallic notes', 'electrical aromas', 'unusual spice combinations']
  },
  'RetrogradeEffect': {
    'Spirit': 0.2,
    'Essence': 0.4,
  ...
  'FoodAssociations': [
    ...
    'technological food preparations',
  ...
  'CulinaryInfluences': [
    ...
    'Disrupts traditional cooking methods',
    'Introduces technological elements to cuisine',
  ...
  'PlanetSpecific': {
    'ZodiacTransit': {
      'Aquarius': {
        ...
        'CookingMethods': ['molecular gastronomy', 'sous vide', 'liquid nitrogen freezing', 'ultrasonic cooking', 'laser cutting'],
      ...
      'Scorpio': {
        ...
        'CookingMethods': ['fermentation', 'smoking', 'curing', 'aging', 'pressure-altering techniques'],
      ...
      'Gemini': {
        ...
        'CookingMethods': ['dual temperature contrasts', 'tableside transformations', 'interactive cooking', 'innovative plating', 'surprise elements'],
        'FavoredIngredients': ['unexpected pairings', 'color-changing elements', 'interactive components', 'deconstructed classics', 'dual temperature components'],
        'FlavorCombinations': 'Playful contrasts, surprising element combinations, intellectual flavor constructs'
      }
    },
    'Retrograde': {
      'CulinaryEffect': 'Revisiting innovative techniques, tempering extreme experimentation, finding balance between tradition and innovation',
      'ElementalShift': {
        'Spirit': 0.3,
        'Essence': 0.7,
        'Matter': 0.5,
      ...
      'CookingMethodEffects': {
        'Emphasized': ['fusion of traditional and modern techniques', 'revisiting abandoned cooking methods', 'refining experimental approaches'],
        'Diminished': ['purely technological methods', 'excessive novelty', 'innovation without purpose']
      },
      'IngredientEffects': {
        'Emphasized': ['forgotten ingredients', 'traditional foods with modern presentation', 'reimagined classics'],
        'Diminished': ['purely shock-value ingredients', 'excessive artificiality', 'technology without purpose']
      },
      'FlavorModulation': {
        'Sweet': 0.6,
        'Sour': 0.4,
