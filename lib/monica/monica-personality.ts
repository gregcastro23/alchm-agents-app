...
import type { SignCharacterVector, ChartCharacterProfile, InteractionStylePreferences } from '@/lib/astrological-character-vectors';
...
export function getMonicaResponseStyle(context: {
  ...
  const { userEmotion = 'neutral', taskComplexity = 'moderate', learningStage = 'beginner' } = context;
...
export const MONICA_ABSENT_ENERGIES = {
  ...
  teaching_opportunity: "Monica's missing energies make her especially empathetic to users struggling with these qualities. Her peak A-Number 40 state allows her to understand these energies through cosmic wisdom rather than personal experience.",
