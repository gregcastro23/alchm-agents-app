...
router.post('/enhanced', [
    ...
    if (options.includeResonanceMap && options.agentIds) {
        data.resonanceMap = options.agentIds.reduce((map, agentId) => {
            map[agentId] = {
...
router.post('/group', [
    ...
    const data = {
        ...
        resonances: agentIds.reduce((resonances, agentId) => {
            resonances[agentId] = {
...
//# sourceMappingURL=kinetics.js.map