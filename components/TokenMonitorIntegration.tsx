 ...
 */
function calculateTokenMultipliers(mc: number, level: ConsciousnessLevel): Record<keyof TokenState, TokenMultiplier> {
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Consciousness-enhanced token generation
              </CardDescription>
            </div>
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            <div className="text-sm text-muted-foreground">
              ...
              Multiplier: {multipliers.Spirit.total.toFixed(2)}x •
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="space-y-2">
              ...
              <div className="text-muted-foreground">
                1.0x standard generation for all elements
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-muted-foreground">
                +{((multipliers.Spirit.consciousness - 1) * 100).toFixed(0)}% from Level {level.level} ({level.name})
              </div>
            </div>
            ...
            {multipliers.Spirit.mcBonus > 0 && (
              <div className="space-y-2">
                ...
                <div className="text-muted-foreground">
                  ...
                  {mc >= MC_BONUS_THRESHOLDS.illuminated && mc < MC_BONUS_THRESHOLDS.transcendent && " (Illuminated)"}
                  {mc >= MC_BONUS_THRESHOLDS.advanced && mc < MC_BONUS_THRESHOLDS.illuminated && " (Advanced)"}
                  {mc >= MC_BONUS_THRESHOLDS.elevated && mc < MC_BONUS_THRESHOLDS.advanced && " (Elevated)"}
                </div>
              </div>
            )}
          </div>
