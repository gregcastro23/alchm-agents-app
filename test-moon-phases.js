...
Object.values(MOON_PHASES).forEach(phase => {
  ...
  console.log(`     Spirit: ${agent.alchemicalProperties.spirit}, Essence: ${agent.alchemicalProperties.essence}`);
  console.log(`     Matter: ${agent.alchemicalProperties.matter}, Substance: ${agent.alchemicalProperties.substance}`);
});
