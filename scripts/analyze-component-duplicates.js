...
function categorizeComponent(filename, relativePath) {
  ...
  if (name.includes('button') || name.includes('input') || name.includes('card') ||
      name.includes('modal') || name.includes('dialog') || name.includes('alert') ||
      name.includes('badge') || name.includes('progress') || name.includes('tabs') ||
      name.includes('slider') || name.includes('select') || relativePath === 'ui') {
    return 'ui';
  }
  ...
  if (name.includes('chart') || name.includes('natal') || name.includes('horoscope') ||
      name.includes('planetary') || name.includes('aspect') || name.includes('elemental') ||
      name.includes('sign') || name.includes('house') || name.includes('zodiac')) {
    return 'charts';
  }
  ...
  if (name.includes('temporal') || name.includes('time') || name.includes('moment') ||
