...
import { generateBasePersonality, generateInitialTrainingScores } from '@/lib/personalized-ai/personality-generator';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (body.answers && body.styleCards && !body.birthInfo) {
      ...
      return NextResponse.json({ config, previewSessionId: `preview-${Date.now()}`, shareLink: `/personalized-ai/${randomUUID()}` })
    }
