      ...
      <div className="relative z-10 border-b border-purple-500/20 bg-black/40 backdrop-blur-md">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Badge className={`${getTierColor(user.tier)} border-0 text-white px-3 py-1 text-xs tracking-widest`}>
                {user.tier.toUpperCase()}
              </Badge>
              <Button variant="outline" size="sm" onClick={() => router.push('/settings')} className="bg-white/5 border-white/10 text-purple-200 hover:bg-white/10 hover:text-white">
                <Settings className="h-4 w-4 mr-2" />
                Settings
              </Button>
              <Button variant="outline" size="sm" onClick={handleSignOut} className="bg-red-500/10 border-red-500/20 text-red-300 hover:bg-red-500/20 hover:text-red-200">
      ...
      <div className="container relative z-10 mx-auto px-4 py-8 space-y-8">
        ...
        <Card className="bg-black/40 backdrop-blur-md border-purple-500/30 text-white shadow-[0_0_30px_rgba(139,92,246,0.1)]">
          <CardHeader>
            ...
            <CardDescription className="text-purple-200/60">Your current consciousness evolution access level</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-black/40 backdrop-blur-md border-purple-500/30 text-white shadow-[0_0_30px_rgba(139,92,246,0.1)]">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <FeedbackModal
                trigger={
                  <Button variant="outline" className="h-20 flex-col gap-2 bg-white/5 border-white/10 hover:bg-white/10 text-purple-200 hover:text-white">
