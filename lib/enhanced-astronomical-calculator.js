...
function calculateMoonPosition(T) {
    ...
    const sigmaL = 6.288774 * Math.sin(MpRad) +
...
export function calculateEnhancedAscendant(birthInfo) {
    const birthDate = new Date(birthInfo.year, birthInfo.month - 1, birthInfo.day, birthInfo.hour, birthInfo.minute, birthInfo.second || 0);
